...
classes = ["Building windows float processed", "Building windows non float processed", "Vehicle windows float processed", "Vehicle windows non float processed (none)", "Container", "Tableware", "Headlamp"]
...
plt.grid('on')
plt.savefig("figures/PCANotStdNormed.eps")
plt.show()
