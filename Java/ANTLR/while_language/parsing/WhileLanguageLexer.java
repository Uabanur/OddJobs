// $ANTLR 3.5.2 while_language/parsing/WhileLanguage.g 2017-04-22 13:05:18
...
public class WhileLanguageLexer extends Lexer {
	...
	public final void mT__17() throws RecognitionException {
		try {
			int _type = T__17;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// while_language/parsing/WhileLanguage.g:22:7: ( 'do' )
			// while_language/parsing/WhileLanguage.g:22:9: 'do'
			{
			match("do"); 
	...
	public final void mT__23() throws RecognitionException {
		try {
			int _type = T__23;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// while_language/parsing/WhileLanguage.g:28:7: ( 'while' )
			// while_language/parsing/WhileLanguage.g:28:9: 'while'
			{
			match("while"); 
	...
	public final void mNUM() throws RecognitionException {
		try {
			int _type = NUM;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// while_language/parsing/WhileLanguage.g:76:5: ( ( '0' .. '9' )+ )
			// while_language/parsing/WhileLanguage.g:76:7: ( '0' .. '9' )+
			{
			// while_language/parsing/WhileLanguage.g:76:7: ( '0' .. '9' )+
			int cnt1=0;
			loop1:
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// while_language/parsing/WhileLanguage.g:77:5: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* )
			// while_language/parsing/WhileLanguage.g:77:7: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
			{
			...
			// while_language/parsing/WhileLanguage.g:77:26: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// while_language/parsing/WhileLanguage.g:79:5: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
			// while_language/parsing/WhileLanguage.g:79:9: ( ' ' | '\\t' | '\\r' | '\\n' )+
			{
			// while_language/parsing/WhileLanguage.g:79:9: ( ' ' | '\\t' | '\\r' | '\\n' )+
			int cnt3=0;
			loop3:
